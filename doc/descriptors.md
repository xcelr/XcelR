# Support for Output Descriptors in XcelR Core

Since XcelR Core v0.17, there is support for Output Descriptors in the
...
- Segwit addresses (bech32, of the form `xcl1...`, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on XcelR's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing XcelR Core wallets, a convenience function `combo` is
