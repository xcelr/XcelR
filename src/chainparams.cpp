...
{
    const char* pszTimestamp = "Bitcoins price broke above 50000 for the first time in history Tuesday";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1613582674, 2084826943, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("223575f02f2421329e9b5a2800b7db67bcec6dcc7f3d36d8c0c5c98638f26e15"));
        assert(genesis.hashMerkleRoot == uint256S("db2a787b35afe5d95dcf4d32483ea0675306d8eec34549496cffd8dc124fd272"));
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = {0xBC, 0x88, 0xB2, 0x1E};
        base58Prefixes[EXT_SECRET_KEY] = {0xBC, 0x88, 0xAD, 0xE4};
        ...
        checkpointData = {
            {
                {  0, uint256S("223575f02f2421329e9b5a2800b7db67bcec6dcc7f3d36d8c0c5c98638f26e15")},
                {  1500, uint256S("f8401137540713a034ca9640200397a09f6f302bc90fbb54ab7f19100805c862")},
                {  3500, uint256S("a8edf5bf143e46ed341e6cf56b8cacb686e3bb2d15482d268d9788109134eb6b")},
                {  5000, uint256S("b3d7258c35bbb62ebea6c7d26a168e78b178bb12c072d0e81a15f0f85facf1ae")},
                {  10000, uint256S("c390e98677ad814794d951b81768f21f5d082cecb22d5627ed9b8404b4623a75")},
                            }
        };
