...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " xcelr-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  xcelr-tx [options] <hex-tx> [commands]  Update hex-encoded xcelr transaction\n" +
            "or:     xcelr-tx [options] -create [commands]   Create hex-encoded xcelr transaction\n" +
            "\n";
